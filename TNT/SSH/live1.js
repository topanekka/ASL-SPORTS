  ...
  <script>
    setTimeout(function(){
        if(typeof _client === 'undefined' || _client === null)
        {
            ...
            messageDiv.appendChild(document.createTextNode("Please Use Chrome only and Disable Your Adblocker & Refresh this page to continue Acess this Website."));
            var mainDiv = document.createElement("div");
            mainDiv.setAttribute("style","position: absolute; top: 0px; right: 0px; width: 100%; height: 100%; display: flex; background-color: red;  align-items: center; justify-content: center");
